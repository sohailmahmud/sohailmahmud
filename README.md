...
Sr. Software Engineer with over 6 years of experience | Expert in scalable cross-platform (iOS & Android) apps, backend integration, cloud deployments, and end-to-end Agile delivery.
...
#### Technical Skills:
* **Mobile Development & Architecture:** Flutter & Dart expert; integrating Swift and Kotlin native modules; building scalable, maintainable apps using
  OOP, Clean Architecture, MVVM, Dependency Injection and advanced state management (Bloc, Provider, Riverpod, GetX).
* **Backend, Databases & Cloud:** Firebase (Auth, Firestore, Serverless, FCM, Crashlytics), .NET Core (Web APIs, Microservices, gRPC, SignalR); Rest &
  GraphQL APIs, Supabase, AWS Amplify; MSSQL, PostgreSQL, MongoDB; local storage and caching with Hive and SQLite; cloud platforms AWS & GCP; ETL
  pipelines with AWS Glue; integrating backend services with mobile apps
...
* **UI/UX & Agile Delivery:** Pixel-perfect UI implementation from Figma, Material and Cupertino designs; Reactive Programming for responsive apps;
  mentoring, code reviews and end-to-end app delivery in collaborative Agile teams

**You can also find me on internet:**
